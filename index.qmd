...
# --- Color palette (defined once, reused throughout) ---
dreamy_color = '#4E79A7'
duck_color   = '#E15759'
...
ax.scatter(dreamy_df['patient'], dreamy_df['post_surgical_score'],
           color=dreamy_color, marker='o', s=55, alpha=0.75, label='Doc Dreamy', zorder=3)
ax.scatter(duck_df['patient'], duck_df['post_surgical_score'],
           color=duck_color, marker='^', s=55, alpha=0.75, label='Doc Duck', zorder=3)

# --- Mean reference lines ---
ax.axhline(dreamy_mean, color=dreamy_color, linestyle='--', linewidth=1.5, zorder=2)
ax.axhline(duck_mean,   color=duck_color,   linestyle='--', linewidth=1.5, zorder=2)

# --- Mean annotations ---
ax.annotate(f'○ Mean = {dreamy_mean:.2f}', xy=(97, dreamy_mean),
            color=dreamy_color, fontsize=10, va='bottom', ha='right')
ax.annotate(f'△ Mean = {duck_mean:.2f}', xy=(97, duck_mean),
            color=duck_color, fontsize=10, va='top', ha='right')
...
# --- Data preparation ---
dreamy_rand_df   = patients_randomized_df[patients_randomized_df['doctor_name'] == 'Doc Dreamy']
duck_rand_df     = patients_randomized_df[patients_randomized_df['doctor_name'] == 'Doc Duck']
...
# --- Scatter plots ---
ax.scatter(dreamy_rand_df['patient'], dreamy_rand_df['post_surgical_score'],
           color=dreamy_color, marker='o', s=55, alpha=0.75, label='Doc Dreamy', zorder=3)
ax.scatter(duck_rand_df['patient'], duck_rand_df['post_surgical_score'],
           color=duck_color, marker='^', s=55, alpha=0.75, label='Doc Duck', zorder=3)

# --- Mean reference lines ---
ax.axhline(dreamy_rand_mean, color=dreamy_color, linestyle='--', linewidth=1.5, zorder=2)
ax.axhline(duck_rand_mean,   color=duck_color,   linestyle='--', linewidth=1.5, zorder=2)

# --- Mean annotations ---
ax.annotate(f'○ Mean = {dreamy_rand_mean:.2f}', xy=(97, dreamy_rand_mean),
            color=dreamy_color, fontsize=10, va='bottom', ha='right')
ax.annotate(f'△ Mean = {duck_rand_mean:.2f}', xy=(97, duck_rand_mean),
            color=duck_color, fontsize=10, va='top', ha='right')
...
# --- Color palette and shaded-region bounds (named for reuse) ---
dreamy_color       = '#4E79A7'
duck_color         = '#E15759'
...
# --- Shaded overlap region (drawn first so it sits behind data) ---
ax.axvspan(shade_lo, shade_hi, alpha=0.15, color='gray', zorder=0,
           label=f'Overlap region ({shade_lo} to {shade_hi})')
...
# --- Mean annotations (anchored to right edge of data) ---
ax.annotate(f'○ Mean = {dreamy_mean:.2f}', xy=(x_max * 0.95, dreamy_mean),
            color=dreamy_color, fontsize=10, va='bottom', ha='right')
ax.annotate(f'△ Mean = {duck_mean:.2f}', xy=(x_max * 0.95, duck_mean),
            color=duck_color, fontsize=10, va='top', ha='right')
